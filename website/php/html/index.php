...
<body class="wallpaper">
    <div id="container">
        ...
        <!-- The Lists -->
        <div id="content">
            <h2 class="medium-heading">List items</h2>
            <div id="todo">
                <!-- To do list -->
            ...
            <form action="form.php" id="addTaskForm1" method="post">
                <h2>Task Manager</h2>
                <label>Task Name: </label><input type='text' id='addTaskName' name='taskName'><br><br>
                <label>Task Description: </label><input type='text' id='addTaskDescription' name='taskDescription'><br><br>
                <label>Due Date:</label><input type='datetime-local' id='addDate' placeholder='Select Date' name='dueDate'><br><br>
                <label>Alarm: </label><input type='checkbox' id='addAlarm' name='yes' value='true'><br><br>
                <label>How long before would you like the alarm? </label><input type='number' id='addAlarmDate' name='time' min='1' max='60'>
                <select id='timeSelect'><option value='hours'>Hours</option><option value='minutes'>Minutes</option></select><br><br>
                <label>Tags </label><input name='tag' id='addTagName' type='text' placeholder='Tag'><br><br>
                <label>Priority </label><input id='addTagColor' name='tagColor' type='text' placeholder='Color'><br><br>
