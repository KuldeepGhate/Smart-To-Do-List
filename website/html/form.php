    ...
    <div id="content">
        ...
        <div id="todo">
            ...
            <form id="addTaskForm1" method="post">
                ...
                <label>Task Description: </label><input type='text' id='addTaskDescription'
                                                        name='taskDescription'><br><br>
                <label>Due Date:</label><input type='datetime-local' id='addDate' placeholder='Select Date'
                                               name='dueDate'><br><br>
                <label>Alarm: </label><input type='checkbox' id='addAlarm' name='yes' value='true'><br><br>
                <label>How long before would you like the alarm? </label><input type='number' id='addAlarmDate'
                                                                                name='time' min='1' max='60'>
