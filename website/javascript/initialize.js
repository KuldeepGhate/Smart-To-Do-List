...
var task2 = new Task("homework", "homework sucks", [tag3, tag2], null, false);
var task3 = new Task("fun", "fun is good", [tag1, tag2], (date.getTime() + 8630000000), false);
var task4 = new Task("blah", "blahhhhh", [tag2, tag4], (date.getTime() + 8650000000), false);
...
var task7 = new Task("yay", "woooooooooo", [tag2, tag3], (date.getTime() - 10), false);
var task8 = new Task("aklsdfj", "duuuuude", [tag4, tag3], (date.getTime() - 10), false);
