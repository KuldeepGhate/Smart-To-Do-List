...
var task4 = new Task("blah", "blahhhhh", [tag2, tag4], (Date.now() + 10000));
var task5 = new Task("merg", "adlfjhasldkfh", [tag3], (Date.now() + 10));
var task6 = new Task("testing", "testestes", [tag4], (Date.now() + 10));
var task7 = new Task("yay", "woooooooooo", [tag2, tag3], (Date.now() - 10));
var task8 = new Task("aklsdfj", "duuuuude", [tag4, tag3], (Date.now() - 10));
