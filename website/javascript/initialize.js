...
var task7 = new Task("Finish book", masterList.allTags[3], (date.getTime() - 10000), (date.getTime() - 100000000));
var task8 = new Task("Finish project", masterList.allTags[1], (date.getTime() - 100000), (date.getTime() - 100000000));
