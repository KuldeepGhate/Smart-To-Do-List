...
var task3 = new Task("fun", "fun is good", [tag1, tag2], (date.getTime() + 1000000));
var task4 = new Task("blah", "blahhhhh", [tag2, tag4], (date.getTime() + 10000));
var task5 = new Task("merg", "adlfjhasldkfh", [tag3], (date.getTime() + 10));
var task6 = new Task("testing", "testestes", [tag4], (date.getTime() + 10));
